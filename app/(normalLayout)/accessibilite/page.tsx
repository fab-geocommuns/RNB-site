      ...
      <div className="fr-container">
        <div className="fr-grid-row ">
          <div className="fr-col-12 fr-col-md-10 fr-col-offset-md-1 fr-pt-12v">
            ...
            <p>
              Établie le <span>24 janvier 2024</span>.
            </p>
            <p>
              <span>
            ...
            <p>
              ...
              <strong>Référentiel National des Bâtiments</strong>
              <span>
                {' '}
                (<span>https://rnb.beta.gouv.fr/</span>)
              </span>
              .
            </p>
            <h2>État de conformité</h2>
            <p>
              <strong>Référentiel National des Bâtiments</strong> est{' '}
              <strong>
            ...
            <p>
              ...
              <span>Référentiel National des Bâtiments</span> pour être orienté
            ...
            <ul>
              ...
              <li>
                ...
                <a href="https://rnb.beta.gouv.fr/contact">
                  https://rnb.beta.gouv.fr/contact
                </a>
              </li>
              <li>
                Adresse&nbsp;:{' '}
                <span>73 avenue de Paris, 94165, Saint Mandé</span>
              </li>
            </ul>
            ...
            <p>
              ...
              d&apos;accessibilité qui vous empêche d&apos;accéder à un contenu
              ou à un des services du portail et vous n&apos;avez pas obtenu de
            ...
            <p>
              ...
              <span>24 janvier 2024</span> grâce au{' '}
