...
export default function Page() {
    ...
    return (
        <>
                    ...
                    <p><span className="stab stab--blue">En pratique, ces ERP ne sont désignés que par une adresse et rarement géolocalisés.</span> Par ailleurs, ce processus varie d’un département à l’autre et l’on constate que ces données sont difficiles à échanger, voir sont parfois perdues.</p>
